        ...
        <div class="modal-content shadow-lg rounded-4 border-0" >
            <form id="formPredio">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label for="id_predio" class="form-label">ID Predio</label>
                            <input type="text" name="id_predio" id="id_predio" class="form-control" required>
                        </div>
                        <div class="col-md-4">
                            <label for="matricula_predio" class="form-label">Matrícula</label>
                            <input type="text" name="matricula_predio" id="matricula_predio" class="form-control" required>
                        </div>
                        <div class="col-md-4">
                            <label for="numrecibo_predio" class="form-label">No. de recibo</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <label for="vereda_barrio" class="form-label">Vereda/Barrio</label>
                            <input type="text" name="vereda_barrio" id="vereda_barrio" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label for="dir_predio" class="form-label">Dirección</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label for="ced_contribuyente" class="form-label">Cédula del Contribuyente</label>
                            <input type="text" name="ced_contribuyente" id="ced_contribuyente" class="form-control" required>
                        </div>
                        <div class="col-md-8">
                            <label for="nom_contribuyente" class="form-label">Nombre del Contribuyente</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label for="valor_pendiente" class="form-label">Valor Pendiente</label>
                        ...
                        <div class="col-md-4">
                            <label for="vigencia_predio" class="form-label">Vigencia</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label for="estado_predio" class="form-label">Estado</label>
                            <select name="estado_predio" id="estado_predio" class="form-select" required>
